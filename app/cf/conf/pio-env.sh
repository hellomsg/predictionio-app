...
MYSQL_JDBC_DRIVER=$PIO_HOME/lib/mysql-connector-java-5.1.46.jar
...
PIO_STORAGE_SOURCES_MYSQL_URL=$JDBC_URL
PIO_STORAGE_SOURCES_MYSQL_USERNAME=$JDBC_USER_NAME
PIO_STORAGE_SOURCES_MYSQL_PASSWORD=$JDBC_PASSWORD
